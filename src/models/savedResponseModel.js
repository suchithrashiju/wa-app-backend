 ...
 * Description: Represents a saved response in the application
 * 
...
// Defines the SavedResponseModel Class
class SavedResponseModel {
  tableName = "bwcrm_saved_responses"; // Specify the table name

  // Method to retrieve multiple rows from the table
  findAllSavedResponses = (params = {}, limit) => {
...
// Export an instance of the SavedResponseModel Class
module.exports = new SavedResponseModel();
