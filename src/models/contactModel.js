 ...
 * Description: Represents a contact in the application
 * 
...
// Defines the ContactModel Class
class ContactModel {
  tableName = "bwcrm_contacts"; // Specify the table name

  // Method to retrieve multiple rows from the table
  findAllContacts = (params = {}, limit) => {
...
// Export an instance of the ContactModel Class
