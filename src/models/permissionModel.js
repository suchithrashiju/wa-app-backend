...
// Define the PermissionModel class
class PermissionModel {
  tableName = "bwcrm_permissions"; // Specify the table name

  // Method to retrieve multiple rows from the table
  findAllPermission = (params = {}) => {
  ...
  findOnePermission = async (params) => {
...
// Export an instance of the PermissionModel class
